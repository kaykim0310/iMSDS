...
<style>
    ...
    * {
    ...
    /* Streamlit 아이콘 폰트 복원 (사이드바, expander 화살표 등) */
...
sections = [
    {'number': 1, 'title': '화학제품과 회사에 관한 정보', 'file': 'pages/1_화학제품정보.py pages/01_화학제품과_회사에_관한_정보.py', 'key': 'section1_data', 'description': '제품명, 용도, 제조자/공급자 정보'},
    {'number': 2, 'title': '유해성·위험성', 'file': 'section2.py', 'key': 'section2_data', 'description': '유해성 분류, 예방조치 문구'},
    {'number': 3, 'title': '구성성분의 명칭 및 함유량', 'file': 'pages/3_구성성분.py pages/03_구성성분의_명칭_및_함유량.py', 'key': 'section3_data', 'description': '화학물질명, CAS번호, 함유량'},
    {'number': 4, 'title': '응급조치 요령', 'file': 'section4.py', 'key': 'section4_data', 'description': '응급처치 방법'},
    {'number': 5, 'title': '폭발·화재시 대처방법', 'file': 'section5.py', 'key': 'section5_data', 'description': '소화방법, 화재 위험성'},
    {'number': 6, 'title': '누출 사고시 대처방법', 'file': 'section6.py', 'key': 'section6_data', 'description': '누출시 조치사항'},
    {'number': 7, 'title': '취급 및 저장방법', 'file': 'section7.py', 'key': 'section7_data', 'description': '안전취급, 저장조건'},
    {'number': 8, 'title': '노출방지 및 개인보호구', 'file': 'pages/8_노출방지.py pages/08_노출방지_및_개인보호구.py', 'key': 'section8_data', 'description': '노출기준, 보호구'},
    {'number': 9, 'title': '물리화학적 특성', 'file': 'pages/9_물리화학적특성.py pages/09_물리화학적_특성.py', 'key': 'section9_data', 'description': '물리적 상태, 화학적 특성'},
    {'number': 10, 'title': '안정성 및 반응성', 'file': 'pages/10_안정성및반응성.py pages/10_안정성_및_반응성.py', 'key': 'section10_data', 'description': '화학적 안정성, 반응성'},
    {'number': 11, 'title': '독성에 관한 정보', 'file': 'section11.py', 'key': 'section11_data', 'description': '독성 정보'},
    {'number': 12, 'title': '환경에 미치는 영향', 'file': 'section12.py', 'key': 'section12_data', 'description': '환경 영향'},
    {'number': 13, 'title': '폐기시 주의사항', 'file': 'pages/13_폐기시주의사항.py pages/13_폐기시_주의사항.py', 'key': 'section13_data', 'description': '폐기방법'},
    {'number': 14, 'title': '운송에 필요한 정보', 'file': 'pages/14_운송정보.py pages/14_운송에_필요한_정보.py', 'key': 'section14_data', 'description': '운송 정보'},
    {'number': 15, 'title': '법적 규제현황', 'file': 'pages/15_법적규제현황.py pages/15_법적_규제현황.py', 'key': 'section15_data', 'description': '관련 법규'},
    {'number': 16, 'title': '기타 참고사항', 'file': 'section16.py', 'key': 'section16_data', 'description': '작성일, 개정정보 등'}
]
